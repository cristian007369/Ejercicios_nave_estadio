...
arriba=PhotoImage(file="videojuego nave espacial_ Estadio/img/arriba.png")
abajo=PhotoImage(file="videojuego nave espacial_ Estadio/img/abajo.png")
derecha=PhotoImage(file="videojuego nave espacial_ Estadio/img/derecha.png")
izquierda=PhotoImage(file="videojuego nave espacial_ Estadio/img/izquierda.png")
fondo=PhotoImage(file="videojuego nave espacial_ Estadio/img/fon11.png")
star1=PhotoImage(file="videojuego nave espacial_ Estadio/img/star.png")
nave=PhotoImage(file="videojuego nave espacial_ Estadio/img/nave .png")
fondo33=PhotoImage(file="videojuego nave espacial_ Estadio/img/fondo_planeta1.png")
